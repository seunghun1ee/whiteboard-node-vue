...
io.on('connection', (socket) => {
    ...
    socket.on("send_chat", (id,chat,anonymous,room,channel) => {
        console.log(`room: ${room} channel: ${channel} user: ${id} message: ${chat} anonymous: ${anonymous}`);
        socket.broadcast.to(room).emit("receive_chat",{chat:chat, anonymous: anonymous, channel:channel, id:id});
    })
