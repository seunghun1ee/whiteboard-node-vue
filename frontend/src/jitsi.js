 ...
 */
export function onRemoteTrack(track) {
    if (track.isLocal()) {
        return;
    }
...
/**
 * That export function is executed when the conference is joined
 */
...
/**
 * That export function is called when connection is established successfully
 */
...
export function joinRoom(roomName) {
    ...
    room.join();
    // document.getElementById("jitsiStatus").textContent = "Joined room: " + roomName;
}
...
export function onConnectionFailed() {
    // document.getElementById("jitsiStatus").textContent = "Connection failed";
...
/**
 * This export function is called when we disconnect.
 */
